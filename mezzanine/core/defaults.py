...
register_setting(
    ...
    default=(
        (_("Content"), ("pages.Page", "blog.BlogPost",
           "generic.ThreadedComment",(("Create a new post"), "Add"),
					 (("Writing Essentials"), "WritingEssentials"), 
					(("Questions?"), "Question"),(("Suggestions"), "Suggestions"),
					(("How to increase your readership"), "Readership"),)),
